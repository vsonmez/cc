...
/**
 * HTTP function to send daily reminders manually
 * Call with: https://europe-west1-homework-tracker-3bc75.cloudfunctions.net/sendManualReminder
 */
export const sendManualReminder = functions.region('europe-west1').https.onRequest(async (req, res) => {
  try {
    console.log('Starting manual reminder notifications...');
    ...
    console.log(`✅ Manual reminders sent successfully!`);
